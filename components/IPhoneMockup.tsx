...
/**
 * Prévia animada de conversa da socIA, inspirada no Great UI Mobile Mockup
 * (Saurabh Sharma, MIT, 21st.dev) e no estilo de chat neutro/escuro do Solace
 * Chat Messages 2 — recriada aqui de forma original com framer-motion, sem
 * dependência desses pacotes. Sequência: foto/pergunta da lojista, indicador
 * de digitação, resposta com custo/preço/margem, legenda pronta, confirmação.
 * Tudo simulado e não interativo; repete em loop, com replay manual.
 * Com `prefers-reduced-motion`, mostra a conversa completa sem autoplay.
 */
...
const SCRIPT: ChatMsg[] = [
  ...
  { id: 2, from: "socia", time: "10:13" },
  { id: 3, from: "lojista", time: "10:13" },
  { id: 4, from: "socia", time: "10:13" },
  { id: 5, from: "lojista", time: "10:14" },
];
...
export default function IPhoneMockup() {
  // passos: vazio(-1), msg0(0), typing(1), msg1(2), typing(3), msg2(4), msg3(5), typing(6), msg4(7), msg5(8), done(9)
  const [step, advance] = useReducer(
    (s: number, a: "next" | "reset" | "complete") => {
      if (a === "reset") return -1;
      if (a === "complete") return 9;
  ...
  return (
    ...
    <figure className="iphone-figure">
      <div
        className="iphone15"
        role="img"
        aria-label="Prévia animada e simulada de conversa com a socIA: a lojista envia a foto do brinco de pérola e pergunta o preço; a socIA responde com custo de 63 reais e 50 centavos, preço de 142 reais e 70 centavos, margem de 64 reais e 21 centavos, uma legenda para o Instagram e um texto para o site"
      >
        <svg
        ...
        >
          <defs>
            ...
            <linearGradient id="wa-photo-bg" x1="0" y1="0" x2="1" y2="1">
              ...
              <stop offset="1" stopColor="#e2cdd2" />
            </linearGradient>
          </defs>
        ...
        <div className="iphone15-screen gx-screen" aria-hidden="true">
            ...
            <AnimatePresence initial={false}>
              {msgs.map((s) => (
                  ...
                  >
                    {s.id === 0 ? (
                      <>
                        <svg className="gx-photo" viewBox="0 0 200 112" focusable="false">
                          <rect width="200" height="112" fill="url(#wa-photo-bg)" />
                          <ellipse cx="100" cy="104" rx="34" ry="5" fill="#000" opacity="0.12" />
                          <path d="M100 52 C 100 30, 120 28, 120 46" fill="none" stroke="#b99a62" strokeWidth="4" strokeLinecap="round" />
                          <circle cx="100" cy="56" r="3.5" fill="#b99a62" />
                          <circle cx="100" cy="78" r="20" fill="#faf5ec" stroke="#d9c6ac" strokeWidth="1.5" />
                          <circle cx="93" cy="71" r="6" fill="#fff" opacity="0.9" />
                        </svg>
                        <span className="gx-text">
                          Chegou hoje: brinco de pérola ✨ Quanto devo cobrar?
                        </span>
                      ...
                      <>
                        <span className="gx-text">
                          Raio-X: custo <strong className="num">R$&nbsp;63,50</strong> → preço{" "}
                          <strong className="num">R$&nbsp;142,70</strong>. Margem de{" "}
                          <strong className="num">R$&nbsp;64,21</strong> por peça.
                        </span>
                      ...
                      <>
                        <span className="gx-text">
                          Para o Instagram: “Pérola do almoço ao jantar ✨ Fecho seguro,
                          banho dourado. Chama no direct! 💛”
                        </span>
                        <span className="gx-stamp num">{SCRIPT[s.id].time}</span>
                      </>
                    ) : s.id === 3 ? (
                      <>
                        <span className="gx-text">E o texto para cadastrar no site?</span>
                        <span className="gx-stamp num">
                          {SCRIPT[s.id].time}
                          <svg viewBox="0 0 18 12" width="15" height="10" focusable="false">
                            <path d="M1 6.5l3.2 3.2L10 3M7 6.8l3.2 3.2L16 3.5" fill="none" stroke="#53bdeb" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                      ...
                      <>
                        <span className="gx-text">
                          Para o site: “Brinco de pérola em banho dourado, fecho seguro e
                          acabamento antialérgico. Peça leve para o dia a dia.”
                        </span>
                        <span className="gx-stamp num">{SCRIPT[s.id].time}</span>
                      </>
                    ) : (
                      <>
                        <span className="gx-text">Amei, vou anunciar hoje! 👍</span>
                        <span className="gx-stamp num">
                          {SCRIPT[s.id].time}
                          <svg viewBox="0 0 18 12" width="15" height="10" focusable="false">
                            <path d="M1 6.5l3.2 3.2L10 3M7 6.8l3.2 3.2L16 3.5" fill="none" stroke="#53bdeb" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
          ...
          <p className="gx-system">Prévia simulada · nada é enviado</p>
      ...
      <figcaption className="iphone-caption">
        Conversa simulada · nenhuma mensagem é enviada
      </figcaption>
    </figure>
    </MotionConfig>
  );
